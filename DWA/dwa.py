...
class dwa():
    ...
    def target_direction(self, x, y ):
        ...
        direction = math.atan2(abs (y - self.y_robot), abs(x - self.x_robot))
    ...
    def velocity_command(self,v, w):
        ...
        self.vel_msg.angular.z = 0 #0 #w
        self.vel_msg.linear.x = 0  #0 #v
        self.v_curr = v
    ...
    def circle_visiualization(self,pairs_list) :
        ...
        for x in range(4):
            ...
            marker = Marker()
            marker.header.frame_id = "base_scan"  #'base_scan'
            marker.id = 100
